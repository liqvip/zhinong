		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			...
			<div class="panel panel-primary">
				...
				<div id="collapsefive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingfive">
					<ul class="list-group">
						<li class="list-group-item"><a href="">农场查看</a></li>
						<li class="list-group-item"><a href="./add.jsp">农场添加</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="panel panel-primary">
				...
				<div id="collapsesix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingsix">
					<ul class="list-group">
						<li class="list-group-item"><a href="../raise_cat/index.jsp">农场查看</a></li>
						<li class="list-group-item"><a href="../raise_cat/add.jsp">农场添加</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="panel panel-primary">
				...
				<div id="collapseeight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingeight">
					<ul class="list-group">
						<li class="list-group-item"><a href="../news_cat/index.jsp">农场查看</a></li>
						<li class="list-group-item"><a href="../news_cat/add.jsp">农场添加</a></li>
					</ul>
				</div>
			</div>
			...
			success:function(data,status,jqXHR){
			   ...
			   for(var i=0;i<data.list.length;i++) {
			      ...
			      tableStr+="<tr>" +
                      ...
                      "<td>"+data.list[i].farmName+"</td>" +
					  "<td><img src='../images/farm/"+data.list[i].farmImg+"' alt=''></td>" +
					  "<td><a href='' data-toggle='modal' data-target='#deletemodal' id='delete' code='"+data.list[i].farmId+"'>删除</a></td>"+
					  "<td><a href='' data-toggle='modal' data-target='#modifymodal' id='modify' code='"+data.list[i].farmId+"'>修改</a></td>"+
					  "</tr>";
			   }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">农场删除</h4>
            </div>
            <div class="modal-body">
                <h4 class="text-danger">你确定要删除该农场吗?</h4>
            </div>
...
<div class="modal fade" id="modifymodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">农场信息修改</h4>
            </div>
            <div class="modal-body">
                <form action="">
...
<script>
    ...
    $(document).on("click","#modify",function (event) {
        var farm = $(this);
        var farmId = farm.attr("code");
        var farmNameObj = farm.parent().siblings(":eq(1)");
		$("#farmName").val(farmNameObj.text());
