		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			...
			<div class="panel panel-primary">
				...
				<div id="collapsefour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingfour">
					<ul class="list-group">
						<li class="list-group-item"><a href="../news/index.jsp">农资查看</a></li>
						<li class="list-group-item"><a href="../news/add.jsp">农资添加</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="panel panel-primary">
				...
				<div id="collapsesix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingsix">
					<ul class="list-group">
						...
						<li class="list-group-item"><a href="./add.jsp">分类添加</a></li>
					</ul>
				</div>
			</div>
		...
		$.ajax({
			...
			success:function(data,status,jqXHR){
			   ...
			   for(var i=0;i<data.list.length;i++) {
			      // 表格拼接
			      tableStr+="<tr>" +
					  "<td>"+data.list[i].newsCatId+"</td>" +
                      "<td>"+data.list[i].parentId+"</td>" +
					  "<td>"+data.list[i].catName+"</td>" +
					  "<td><a href='' data-toggle='modal' data-target='#deletemodal' id='delete' code='"+data.list[i].newsCatId+"'>删除</a></td>"+
					  "<td><a href='' data-toggle='modal' data-target='#modifymodal' id='modify' code='"+data.list[i].newsCatId+"'>修改</a></td>"+
					  "</tr>";
			   }
...
<script>
    ...
    $(document).on("click","#delete",function (event) {
        var newsCatObj = $(this);
        var newsCatId = newsCatObj.attr("code");

        //单击确定按钮进行删除操作
        $("#yes").click(function(){
            $.ajax({
                url:"delete/"+newsCatId,
                method: "GET",
                success:function (data) {
                    newsCatObj.parent().parent().remove();
    ...
    $(document).on("click","#modify",function (event) {
        var newsCatObj = $(this);
        var newsCatId = newsCatObj.attr("code");
		var catNameObj = newsCatObj.parent().siblings(":eq(2)");
        var parentIdObj = newsCatObj.parent().siblings(":eq(1)");
