			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			  ...
			  <div class="panel panel-primary">
			    ...
			    <div id="collapsefive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingfive">
			      <ul class="list-group">
			      	<li class="list-group-item"><a href="./index.jsp">农场查看</a></li>
			      	<li class="list-group-item"><a href="">农场添加</a></li>
			      </ul>
			    </div>
			  </div>
			...
			<form action="" method="post" enctype="multipart/form-data" id="f1">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">农场信息</h3>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<label for="">农场名称：</label>
							<input type="text" name="farmName" id="" class="form-control">
						</div>
						<div class="form-group">
							<label for="">农场图片：</label>
